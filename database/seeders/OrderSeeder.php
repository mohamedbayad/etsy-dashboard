...
class OrderSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Order::create([
            ...
            'color' => 'Marron',
            'size' => '42',
            'note' => 'Text for note example for the order 1 in the database to test the note field',
            'customer_name' => 'Ahmed',
        ...
        Order::create([
            ...
            'color' => 'Rouge/Bleu',
            'size' => '200x300',
            'note' => 'Text for note example for the order 2 in the database to test the note field',
        ...
        Order::create([
            ...
            'color' => 'Noir',
            'size' => '40',
            'note' => 'Text for note example for the order 3 in the database to test the note field',
            'customer_name' => 'Ahmed',
            'email' => 'ahmed@example.com',
            'country' => 'Morocco',
            'quantity' => 1,
