            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="p-6 flex justify-between items-center">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <a href="{{ route('admin.stores.edit', $store->id) }}"
                                   class="w-12 h-12 inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground ">
                                ...
                                <form action="{{ route('admin.stores.destroy', $store->id) }}" method="POST" onsubmit="return confirm('Wash sure bghiti tms7 had store?');">
                                    @csrf
                                    @method('DELETE')
                                    <button type"submit"
                                            class="w-12 h-12 inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-destructive text-destructive-foreground hover:bg-destructive/90">
                ...
                @empty
                    <div class="col-span-full text-center p-12">
                        <p class="text-muted-foreground">Makayn 7ta store m-enregistré daba.</p>
                        <a href="{{ route('admin.stores.create') }}"
